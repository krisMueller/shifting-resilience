...
| Script | Description |
| :--- | :--- |
| `GEE00_Ndvi_Coomposite_Generation.js` | **Foundational Step:** Processes raw Landsat imagery into annual NDVI composites. **This is a precalculated asset in GEE02**|
